...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="${contentList.get(0).img}">
        </div>
        <div class="item">
            <img alt="Second slide" src="${contentList.get(1).img}">
        </div>
        <div class="item">
            <img alt="Third slide" src="${contentList.get(2).img}">
        </div>
        <div class="item">
            <img alt="Third slide" src="${contentList.get(3).img}">
        </div>
...
<div class="main container">
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${studentList.get(0).img}" height="300px" width="200px">
                    <span>${studentList.get(0).opt}:${studentList.get(0).name}</span>
                    <p class="text-left">${studentList.get(0).intro}</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${studentList.get(1).img}" height="300px" width="200px">
                    <span>${studentList.get(1).opt}:${studentList.get(1).name}</span>
                    <p class="text-left">${studentList.get(1).intro}</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${studentList.get(2).img}" height="300px" width="200px">
                    <span>${studentList.get(2).opt}:${studentList.get(2).name}</span>
                    <p class="text-left">${studentList.get(2).intro}</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${studentList.get(3).img}" height="300px" width="200px">
                    <span>${studentList.get(3).opt}:${studentList.get(3).name}</span>
                    <p class="text-left">${studentList.get(3).intro}</p>
                </div>
            </li>
        </ul>
    </div>
